...
export function ProcessContractDetails() {
  ...
  const handleAdd = () => {
    ...
    reset();
    navigate("/transaction/process-contract-entry");
  };
  ...
  const handleEdit = (order: DyeingWorkOrder) => {
    ...
    reset(order);
    setIsModalOpen(true);
    navigate("/transaction/process-contract-entry", { state: { order } });
  };
  ...
  return (
    <div>
      ...
      <DataTable
        ...
        title="Dyeing Work Order Details (FABRIC)"
        onAdd={handleAdd}
        onEdit={handleEdit}
